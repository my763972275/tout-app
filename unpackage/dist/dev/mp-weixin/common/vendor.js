...
/* 4 */
/*!******************************************!*\
  !*** D:/test/mobile/tour-app/pages.json ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 7 */
/*!***********************************************************!*\
  !*** D:/test/mobile/tour-app/pages.json?{"type":"style"} ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/strategy/strategy": { "navigationBarTitleText": "攻略", "usingComponents": { "address": "/pages/strategy/components/address", "content": "/pages/strategy/components/content", "location": "/pages/strategy/components/location" }, "usingAutoImportComponents": {} }, "pages/index/index": { "navigationBarTitleText": "飞猪旅游", "usingComponents": { "search": "/components/search", "swiper": "/components/swiper", "menu": "/components/menu", "classify": "/components/classify", "scroll-view": "/components/scrollView", "content-menu": "/components/content" }, "usingAutoImportComponents": {} }, "pages/my/my": { "navigationBarTitleText": "我的", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/city/city": { "navigationBarTitleText": "选择城市", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/publish/publish": { "navigationBarTitleText": "发表游记", "usingComponents": { "h-mmessages": "/element/HM-messages/HM-messages", "modal": "/element/modal" }, "usingAutoImportComponents": {} }, "pages/details/details": { "navigationBarTitleText": "详情页", "usingComponents": { "navs": "/pages/details/components/navs", "swiper": "/components/swiper", "matter": "/pages/details/components/matter", "comment": "/pages/details/components/comment" }, "usingAutoImportComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "飞猪旅游", "navigationBarBackgroundColor": "#ffd300", "backgroundColor": "#ffd300" } };exports.default = _default;

/***/ }),
/* 8 */
/*!**********************************************************!*\
  !*** D:/test/mobile/tour-app/pages.json?{"type":"stat"} ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__B6C5F62" };exports.default = _default;
...
/* 15 */
/*!**********************************************!*\
  !*** D:/test/mobile/tour-app/store/store.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  // 可以执行异步操作
  actions: {
    listact: function listact(_listact, listdata) {
      // 三个页面同时传值过来发送ajax请求
      // 得到请求结果之后再传给mutations
      _listact.commit('listmut', listdata);
    } },

  // 直接执行同步操作
  mutations: {
    listmut: function listmut(state, listdata) {
      state.list = {
        listing: listdata };
    ...
    // 以对象形式传过来的参数
    navmuta: function navmuta(state, obj) {
      state.navmin = {
    ...
    // 获取城市参数
    citymuta: function citymuta(state, data) {
      state.city = {
        citydata: data };

    },
    // 发布成功后是否重新刷新页面
    routmuta: function routmuta(state, flag) {
      state.routing = {
        flag: flag };
...
/* 23 */
/*!**************************************************!*\
  !*** D:/test/mobile/tour-app/commons/js/list.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.cityDetail = exports.locationData = void 0; // 定位
var QQMapWX = __webpack_require__(/*! ./qqmap-wx-jssdk.js */ 24);
var qqmapsdk;
...
// 关键字关联查询
exports.locationData = locationData;var cityDetail = function cityDetail(value) {
  return new Promise(function (resolve, reject) {
    qqmapsdk = new QQMapWX({
      key: 'CHNBZ-JL4WO-KK3WK-SW53F-VTK3K-VGFNT' });
...
/* 24 */
/*!************************************************************!*\
  !*** D:/test/mobile/tour-app/commons/js/qqmap-wx-jssdk.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!******************************************************!*\
  !*** D:/test/mobile/tour-app/commons/js/cloudFun.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.selectData = exports.uploadFiles = exports.addDatabase = exports.homelist = exports.home = void 0; // class 面向对象类
// promise 封装
var db = wx.cloud.database();
// 请求轮播，tab数据
var home = function home(coll) {
  return new Promise(function (resolve, reject) {
...
// 分页请求攻略列表的数据
exports.home = home;var homelist = function homelist(listdata, pageid) {
  return new Promise(function (resolve, reject) {
    var collData = db.collection(listdata).limit(2).skip(pageid * 2);
    collData.get().
    then(function (res) {
      resolve(res.data);
    }).
...
// 云数据库添加公用函数
exports.selectData = selectData;var addDatabase = function addDatabase(userInfo, coll) {
  return new Promise(function (resolve, reject) {
    var users = db.collection(coll);
    users.add({
      data: userInfo }).
...
// 上传文件到云数据库的公用函数
exports.addDatabase = addDatabase;var uploadFiles = function uploadFiles(newPath, data, coll) {
  return new Promise(function (resolve, reject) {
    wx.cloud.uploadFile({
      cloudPath: "".concat(coll, "/") + newPath,
      filePath: data }).
...
/* 59 */
/*!****************************************************!*\
  !*** D:/test/mobile/tour-app/commons/js/common.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.timer = exports.previewImg = void 0; // 图片预览函数
var previewImg = function previewImg(arr, index) {
  return new Promise(function (resolve, reject) {
    uni.previewImage({
      urls: arr,
      current: index,
...
// 获取当前时间函数
exports.previewImg = previewImg;var timer = function timer() {
  var date = new Date();
  ...
  var dateTime = year + '-' + month + '-' + day + ' ' + hour + ':' + min + ':' + second;
  return dateTime;
};exports.timer = timer;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
